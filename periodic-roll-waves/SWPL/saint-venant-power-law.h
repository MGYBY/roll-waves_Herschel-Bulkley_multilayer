...
// 	hllc (hm, hp, um, up, Delta*cm[]/fm.x[], &fh, &fu, &dtmax);
	...
	// switch to this for a sharper scheme with better resolution
	// kurganovSharp (hm, hp, um, up, Delta*cm[]/fm.x[], &fh, &fu, &dtmax);
	// or using HLLE scheme
	// hlle (hm, hp, um, up, Delta*cm[]/fm.x[], &fh, &fu, &dtmax);
